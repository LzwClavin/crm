    ...
    <div style="position: absolute; top: 15px; right: 15px;">
        <ul>
            <li class="dropdown user-dropdown">
                <a href="javascript:void(0)" style="text-decoration: none; color: white; margin-right: 40px"
                   class="dropdown-toggle"
                   data-toggle="dropdown">
                    <!--
                    显示数据表中的真实姓名，显示的是当前登录成功的用户的姓名，所以需要从session域中取出User对象并获取其中的name
                    这里使用EL表达式的简写形式，直接获取域中的user对象的name属性
                    如果使用Ajax实现本功能，需要写一个目标Servlet类，并从中获取到session域的User对象的name，再响应给前端
                    最后设置span中的值，整个过程非常麻烦；使用jsp是很方便的，因为底层还是Servlet，直接获取session域的数据即可
                    -->
